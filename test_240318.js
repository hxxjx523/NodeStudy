...
console.log(aa === bb); 
// 6-1. 다음 값이 다른 이유는?
console.log("값이 다른 이유는... null은 값을 넣어줘야 됨");
...
// 8-1. 다음 값이 다른 이유는?
console.log("값이 다른 이유는... ??는 왼쪽이 거짓이면 오른쪽 반환, ||는 null이나 undefined인 것 말고 반환");
